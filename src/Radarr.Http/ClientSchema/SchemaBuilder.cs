        ...
        private static Func<object, object> GetValueConverter(Type propertyType)
        {
            ...
            else if (propertyType == typeof(IEnumerable<int>))
            {
                return fieldValue =>
                {
                    ...
                    else if (fieldValue.GetType() == typeof(JsonElement))
                    {
                        return ((JsonElement)fieldValue).EnumerateArray().Select(s => s.GetInt32());
                    }
                    else
                    {
            ...
            else if (propertyType == typeof(IEnumerable<string>))
            {
                return fieldValue =>
                {
                    ...
                    {
                        return ((JsonElement)fieldValue).EnumerateArray().Select(s => s.GetString());
                    }
                    else
                    {
